...
rdata <- "https://github.com/ucb-stat133/stat133-fall-2015/raw/master/data/superbowl_teams.RData"
download.file(url = rdata, destfile = 'superbowl_teams.RData')

# load data in your R session
load('superbowl_teams.RData')
